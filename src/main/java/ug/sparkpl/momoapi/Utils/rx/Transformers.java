...
public final class Transformers {
     ...
     */
    @Deprecated
    public static <T> NeverApiErrorTransformer<T> pipeApiErrorsTo(final @NonNull PublishSubject<ErrorResponse> errorSubject) {
     ...
     */
    @Deprecated
    public static <T> NeverApiErrorTransformer<T> pipeApiErrorsTo(final @NonNull Action1<ErrorResponse> errorAction) {
